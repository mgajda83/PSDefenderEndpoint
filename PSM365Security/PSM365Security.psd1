#
# Module manifest for module 'PSM365Security'
#
...
RootModule = 'PSM365Security.psm1'
...
Description = 'Modul PowerShell do obslugi API Microsoft 365 Security.'
...
FunctionsToExport = @('Get-Indicator', 'Import-Indicator', 'Submit-Indicator', 'Remove-Indicator', 'Get-IPStat')
...
FileList = @('PSM365Security.psd1', 'PSM365Security.psm1', 'Get-Indicator.ps1', 'Import-Indicator.ps1', 'Submit-Indicator.ps1', 'Remove-Indicator.ps1', 'Get-IPStat.ps1')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/mgajda83/PSM365Security/blob/main/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/mgajda83/PSM365Security'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBqAVlaVaZCELPA
# gFnaJ9djWsi0gWKevFpsbeabgdvvjKCCJngwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIA9vNsrPLf7KviTYF/O3T6kC
# 3bcgBlCrapOiIYHx0bPGMA0GCSqGSIb3DQEBAQUABIICAIxdrjFj0hT1mvyNAlLr
# Ik80UCBZI+AUhkDBvBA9EOjhsz7TRYuV6GNZwd4UfWu0DH84eQed8xI6P9TPjWWD
# S5CnshoyP/q7puZ6wJdGI11EAa+kFr9AR6Y5gvGMFjs7pZrkODmIRm51Nu0oneyd
# 19xDwAAt0Q6rgcnkIoBqadU16IC7zvOQO/R/Ga/5/7R0Ejzj32ulRndpeHVIJVJN
# c3EvoL1HQaH3fnBMa/kXAm7HGq6kBJ1rVIaHvEsUetEB2X6+/WYMU4Qkx/E6wGqO
# srwMlElKJFsqnO+G29S2z3PumsSGujA5Ewf4JkaNem7ZtAgQplE6wWUgUnD15x6t
# ZbKFQ7BVB8NxmnPO35hj+/dXHd+5BzKAOfXEQy9RNAPisyuKvrBCogtnv/DB2Sx4
# TBPaVYjh34tHu/FlGIad3XxmxxhwkAhxzMJ9+KvIBZpQbTnSCiAHixSF1ObY9FCG
# v/bUO9bpmeXIa00DRKkd1W28sJhFb6j/bco/uRQtAb0GuG3vLSBVzQwSpm3VTju4
# K1345yLPlj3boh6jItHwCGGZ/nLCe68I7MkE06A0aXNxZlO4j6SNDwJTHBEKjp4/
# UIfnVmJ+SdWKUL0UjbgTxfAd6fC1OKo/sXAxJFYs21bKI+ABaNinqMM3tUZtWVYa
# FdDsX3Pelzx0vAklL2KVTKusoYIEBDCCBAAGCSqGSIb3DQEJBjGCA/EwggPtAgEB
...
# CyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yMjAzMjkxNjQzMTZaMDcGCyqG
# SIb3DQEJEAIvMSgwJjAkMCIEIBtZv+jldyus9kO7eay0joFYeE8hxVSuE0dtOho+
# BcXTMD8GCSqGSIb3DQEJBDEyBDBsFs6TvGLW4rwM7gtXAWQcV5M5z9K3owy9Gv14
# 9t5c3CxHKmbVB4RSLw8s4oG366owgaAGCyqGSIb3DQEJEAIMMYGQMIGNMIGKMIGH
...
# DQEBAQUABIICAHH06dACJHMZf6bdDgRVNiyLAJK5VbvXwW2NPFeUYqMt/AK3i70B
# TMhlbunaRztwOb3mki4AL/7yCBAqch+5M1gRGaUOvKooKHXFv9/bjCzq0UqUz8zc
# dZ0ivP5RMUeg6xm3VV83PqCp2HBVi5Ho/irVoRJjhkQzFfpCiPhl5X0/RkMcy4sJ
# JeAwKyb9IjjWYaGk834ecBqidkN+4Cnzpo7y3Br3sMmFR0DCpBflYzRtTTL0iDWM
# ufVqFt1byJxgLoohNgBVL6gY5qxbeKxdowvukbBHmoyvHQw6R3Ut2xcR4ocim3cr
# YrvC+HEbCH2BUhaqjsafdGFDEREA9dZ78j+LVgZ7NrANIOLFL+TJkUngZnav2bxZ
# UEW+o8fuo4KFAhcJMVdXMGpUNywthxozZD7EVb6dh5q4wQYeFUlrmgSlLVnkvyMb
# 1zoNUdC8VBxqku50M0/8we2vGu8NXpUx2Gp8cBp4+b+sHa0OfOvkOByA8DZ600yY
# LARMtfRlN23LACp7M0kfSvSKgbDdhyMpEYz60icurNQXKPQab/LCIbrSSNv5MYIQ
# zj7N+TvddYpbQeexkHF4ye/N/VmwL0yCVpiKm6lQYseqF0GU0siA6eDLc0rA7W3N
# m5kD+cmA/5rjM4WADEqjowfRwP5U7BXuizecipZuJpX8NyXeZiC9lwkG

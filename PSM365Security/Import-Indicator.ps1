Function Import-Indicator
{
    <#
	.SYNOPSIS
	    Import list of Defender indicator.
	...
	.EXAMPLE
        ...
        Import-Indicator -Token $Token -Body $Indicator
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAsKVHTYBy4gjrb
# P/S7k4p0ul+sRj6o5xxqGeVVb53PiaCCJngwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAgTbFPiIVLdUWScvIVr2/dg
# UErVjBnv7SqGOe7FKaTSMA0GCSqGSIb3DQEBAQUABIICAKhHm6mz0NYjb2AivnJ0
# mkX8XwltTn4okKpnhzD6NYUUjjOeniWKXDRaK2JZdose1q/O6PF33AZk1P1RhmGz
# EAd2FQlEcNjJyclsJe01DjLdiypIPS0B8vPeEcuKmDtdFprU+D+PiDEzH/Q8XktK
# j0m9bQXDQPRwnJtSwGKXdZW8vnZMNv9tgZlm9I0aESObOIpQZsE+oPpTQdJ1UWQv
# 0w7H8DbUwltwaKGkBE0ELb3lG5ObKj2wXf4cduJ4mFnMj0pSTnD8BRllnUvWgI78
# 94+VN4ovZa97RymF/vVT4gLmQ3XzJCiBs6iDOjA00BM5x9RL5AT26PeN3AoC+pbK
# C4ZMKy53DbbvXaegeGrA7XeayfpCsGKcSh3bnqV9FTmw5RkJCXOlFn0H5vlA81sA
# 21m2O+v3fLrtg2WnG/XuhlmCBpE+iRzXyUAzXw2kV8PO0u55KhfJtXHdQGuniIXI
# 4d2NYun3fKNphJ5AdT/PKv2s9DLUm8xvFHJ/bqLlt8UKXpXhnMi3MszR308KulvF
# 1OZY4ZKLNZbe73a3Of4W9L60UcvSZWBjj5lD/ZQFJworGtXWbOC6OIieKQn9ZUa5
# 4sdcdkuU/6gtGzBebDcOQZwNVb04tivVL8T01tIes3EAXbbiHP7I0w8Z9IzJJnGN
# yA/HhhgKM6NlTW8McpZiHjEkoYIEBDCCBAAGCSqGSIb3DQEJBjGCA/EwggPtAgEB
...
# BcXTMD8GCSqGSIb3DQEJBDEyBDC9XaVliiK/wTPG381zF9AZVKY9OUF9Vo4SUByS
# y7NS5BkhNi+qCaE4EQecjudjGTcwgaAGCyqGSIb3DQEJEAIMMYGQMIGNMIGKMIGH
...
# DQEBAQUABIICACcgfWjAlr8IAx3WdhshZ7nKLiqKCwm992r23/i1aL7kbXn2iyL/
# xixgbu/6o/T9HU8q6wD0ULYsztP6tz3zntD0Ll4pI7e+v0nJ1xk4pAS2mvmb2AsE
# lnluG2GMFQ057s9cFflMhzu58Re1vi/b4aIz6Nvs1pquhlOnS+ybnCPSliaRY0JY
# E+LYqHt/TXvVp6rVLLow0g3QCt0BY++mGOmqAik8J9wIc3JZgb/9/lyK/qyesM/E
# iuLReGmCc0ZOs5jfDHfElkyLJ5OuX63Rm2Sc0fJd9jTe/cPH/G0HyLVXiS5XNTZS
# LjnvDA1yVZ6T3bMrws6tGI0kh2j9vgOP9VdX2GtOH6mvyXzD1wiM6+GK+O8cu1oh
# PWZTdUbxgrxIP67ASnhEo1ifrjQit3rd7AWLpAsk8JB7qaXCV1VHaE2znybe+cun
# Er1XB+N6yuSijNrctXlcuDlJOvhngvm0lajL90Xe+q3GDro0i3IFB3/KYO6xv5Ud
# 9KRMXrmcIJgTFMUQWTvCiVgAvGSXMxM8k1jwJqOA0qRsoBkFEpQ6rJ0JoYaVX1J9
# f1CFssXv8BPbLy2ArNRciXvP1EwRszrCmJPPJtYUpIP24xLGjtXhwB0M0+o2C64C
# 2Hungy00aECBScLnw7sAi0UrlOayZu98fObjjA7FPwAVIMdORBRuYjrb

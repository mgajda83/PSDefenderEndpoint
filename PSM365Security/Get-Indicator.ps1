Function Get-Indicator
{
	...
	.EXAMPLE
        $Indicators = Get-Indicator -Token $Token
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDysHSM986+t2Tl
# PGt5xQoshdFneeIc/juW1TADGsKRZKCCJngwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGEQZISx5IR793W0bpncF8nY
# JbnWuNJK3no81k/U7dgQMA0GCSqGSIb3DQEBAQUABIICANDy4mDMxlN+5+UPgVsj
# QL48NHGGNXFVvk/V2kBtIUbBoKfpwpcPIE2l7p7CuksC15M2T2cvhT9vQmoGoZ0/
# gaOoiUsoiHRVRnOI49sw8mvzXGqgAlRlMIVZunzK3FaPfwhjc+HuIm+jyQhJY6jf
# F7l+Wprp6yrfy8svZwCcA7DzF6leWIYSVU42eeeIQLCdcdKbMMFZtPR1FxNoalwx
# lhiFZJDhjc8ymkuEtem1PtySmfPvMO70qpINhgSm9eKzNPrQDE/UNDx7h7ZQVCP0
# an6RrHNqCQxDfSHfZivmg5q1LBaNBQaLyLkY0dtrfX0KtptNrqCe08s+308n6Lwh
# fS5RfkO2TKjzZ/A09SOxjKWR86rurPL70d1IjcExsCcuzN33SXRUmwk1V4nJVrvb
# u0P8IIYkfP4lRrf/OcrJ55kXyH2NptLN3fGAmi2xFoMtBieU/yAeZJxOoTENP58k
# Q6kajXMDeLqhrUrE3pCUQNQfgkT3Ns9d2o+w2smshCKtTU3mzNOmrGMfQkRY/chg
# +lDbjjaZuWZUD5wM9Alztinntd1L7Qoq/Vd6jm3SaGqKX5/bWP/7CokZkAqViPpo
# 715LTWZDpQPrHToTqSg3aAHzNazVL+YrknvIRjGHvJh/Ruf9EYUxvuifC5sliSTh
# pS1UU4PL4iMAq+/CCYz0MSRCoYIEBDCCBAAGCSqGSIb3DQEJBjGCA/EwggPtAgEB
...
# CyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yMjAzMjkxNjQzMTVaMDcGCyqG
# SIb3DQEJEAIvMSgwJjAkMCIEIBtZv+jldyus9kO7eay0joFYeE8hxVSuE0dtOho+
# BcXTMD8GCSqGSIb3DQEJBDEyBDBnrzGtJRwJet+TJZSzBGEdZ4T3KRE9hih1GxGA
# EMa6W2QcwUzUxq4Qni8UVwZelgkwgaAGCyqGSIb3DQEJEAIMMYGQMIGNMIGKMIGH
...
# DQEBAQUABIICAJ/2jLtx6NVQJ1UBXTGGpqtetVaVnrje5SMupYCCAlP90iTTQZ8d
# hc7krPbQIMBfUri6MLncAmNyvyahgl3CqHn/pHeW4xBoBGuJP1gZvqpZFT5Kfmqp
# gjEjROMEZHIHJlZZ/2gHEAo5LfpmUTkZmNKp2neeit+XhWU8W+CiuRaoIvpUdLWn
# TuBofR6thT5CZW6M5yfhjMK6K092TNoDhuKxQZj+ojbs6ZlOec7nzVY+pnNS/Ahf
# uVfWK2Nh5fy0bnBL1rrtKjg481ACf7O6JBqNPHDBbYVzSkql7dx38jwH+Wkyy51r
# z+hdGCRzwqhGM5ri7F3vOvGLnibfmkfPwLQ1P/TseTdOvk99UukwpFC6jMtxgIUz
# p8xBZz7aVcFtV73CAM9RI4devSB48JyF7MyX2YisRc/h50DBDFXRlJXgOCYBnoL0
# NTKCDsTdXRZYaexpVuOMr7V8lv5GvNwS3K1ySClsUG5nzMHpT4kltteSp86aDcZZ
# 7dd+j/vcEl//v+d4EVBQmVBG0CSjd9jDzdswIhi/EjqxilQCvEM8KxHpRwkW3kpg
# qrwAsBtifNTo8xDfw7xtcI9GwUK7XL1c77v5w9xYkRnPw/zYHohq/1Uh/+etV6Q2
# mKRF4Ntv/aYRJS+Wuqn56Mno4n1boNvBVQrNnZ+gQQ6XhpKq0jk82GVL

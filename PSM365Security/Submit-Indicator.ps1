Function Submit-Indicator
{
	...
	.EXAMPLE
        ...
        Submit-Indicator -Token $Token -Body $Indicator
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD9BgP0rIHaMM1q
# dh54kfjiPs+YdTOoD3m1hVdy9vjWfKCCJngwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILQYyUMd2/lFzMgSDeNjIVud
# CxIzvxIbfsnhbylYLg2YMA0GCSqGSIb3DQEBAQUABIICAIssQcr9HibXIi9SpzTm
# 6qtxcQhU6K6VWJ1OpVxhqhEPZtGVUbS/rk3tu2Kv6J1pVz6APd9yKq56O7kxSl6S
# ojSpBOj6vdcravJEJLwszVr5V6s8M3kzwQGaouSEpB/Ld6Hi4aUQvzDmeVRV1GPT
# OeIRk0Pe4MXzIdFHXz7JpgtljdfwP+EDtfreT1gY9sl3rNuqOM3bDWrd2vAdlKfb
# dMZq2uH4APvTI36i4squoCf66NLtn+GqADr55GrHHKn6bJZYAyL7rnHl8AfJg/fT
# wntEqvJ5inWq4dnUx/MrR/hmTLZSlkcht3WcgLZqm2zpl5CjO1y7kW2YdmdacsPS
# a8yjCN4HumM/nDW4Aw7jdZ869CKHvhh/H/r4xhIZ/+qSAaKVddkg0KMqyjfJjg8n
# 8EdwHAqM+taaCsyl4PtHu+blXBye6Q8lJOKZo1ftCSrOMfyvY+xKk1eqhSlehjWo
# YqbQqGeOzAlFJZKl93yCgAqXiP9G7tfYrYiQjtpPhKwBWm13S1uqdyD0ZZmjUelI
# +VLmmAlwAjBxiCbz472AEU3hzmod2t2k4+S+sdSGp7h+O+pCo5L4VTtrZwqyTlpt
# JAcr2RPzsSGndQMUadxLBwB23afSM3YI9FZ4HQtdZcQ1gjvFqpb6ZKp5yuMOyvki
# Cs/zyA4qGlKlQgUHDrsyxP8GoYIEBDCCBAAGCSqGSIb3DQEJBjGCA/EwggPtAgEB
...
# CyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yMjAzMjkxNjQzMTdaMDcGCyqG
# SIb3DQEJEAIvMSgwJjAkMCIEIBtZv+jldyus9kO7eay0joFYeE8hxVSuE0dtOho+
# BcXTMD8GCSqGSIb3DQEJBDEyBDDbodbJfyMQCj4Zqko2Q9ECqYxkFbRR2FiHRMeK
# ndCzm6Y2TFuMCv+uUx2oysi/DMgwgaAGCyqGSIb3DQEJEAIMMYGQMIGNMIGKMIGH
...
# DQEBAQUABIICAAccvjS4bl2a/JfEZNNyS6FEfd1E307432LIhl0w2RdecueuQ9Ii
# Pvzb8EcIjSKfYsnhUQY36sANSV5fS5vwl+dU4TSvVHWKG2GxtCYCrQFRYi0DLD0u
# zYGRdJOOOSh2gMUZWyqDi6fs531/vkyWp3k7cmN9niyTCBFOATrdQomzXTo3vfTP
# t07V9ElM3a5Lp3MLeMG0a9TilCdWipSMWj33x5d4F1n3l2+nXlfxS7AuzyAVnCW8
# T8E7Cgyrz6cEMJvDb9BtnS1iORKmxZDjcBAYxGNl4P8ZDH13/6c5NQsTlOAlJW3z
# W1nre7jh4w0w8QbBguSah1W65DvuCoBjpdNlD+fba0latjdYrGn+ZlZk+cvCcrZU
# 8d6j2un3m1r0Qs11ghSO97Td6cnud1CAMu6QqIM8XrKFWb4OAtxIYhadXrqyCVfa
# NWIYX6En6M6fzaAlvivWOqhy19xemRIMNVNGPP2q9szS95SNTKZorYOR6uUvTuxm
# TOihQUPHV6ZiAObFxEIZI5XxoRdDAXzxAi8DLtTzeKezs8OHxNcwnWPEPE8CxHfe
# XCjmdWeThh8Yl0oyH5rLtA2lrTB7iz+euKbDjMNCTAHIDmvtSdpcNnvJ+8WmhR+u
# OUEJnS3oFxN6hEBqsqMtROOuCXE2L59GIUTLvl7Ct3Sd4HxHsBEViiNE

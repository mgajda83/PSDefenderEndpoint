Function Remove-Indicator
{
	...
	.EXAMPLE
        Remove-Indicator -Token $Token -Id 5
    ...
    Process
	{
        ...
        $Uri = "https://api.securitycenter.windows.com/api/indicators/$Id"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCnRzcB+MkD03P3
# Tun/cvdhYZDyQ6qeppbXK/BR6BEYB6CCJngwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKj+3tQSd3Rgg+dUF8qScyN3
# YY7hpb5J14rgtf0ngud1MA0GCSqGSIb3DQEBAQUABIICAEf3ef81jVYWiV/kL7L9
# R+DatWj7h5nLRuW+TSnIwRpOF2WLRCOI01sQYl9BfwnCPFEd88jbytLt5yObahKn
# oin9unq/SNl9H98SWnnoYnEhDf8HRr3IwEz8K+ByjKLufNUP13TtsFgDXJh6IPFr
# GzDc0WFEmvh/GpMG7/0hRzmiDne3p3xXyQNhZkmFcnSZ53UNASEzetcJq4pm1lu9
# jc4hbZpaTbREBMD0Gtw6NKM3zEA8tu3fnqv6jGinhDENEgD9m3UWZfaXsSVh2Zer
# 7FY9KP9/zLJeHxE+fPbYBruxVcdyCAc9AS4XuvZbcGe/q8nV93menqK7MYuNe9DZ
# pMgycDIUGXXdJx+jHJ9MS6uiKv2AgpbUDTVour1+lpb5BExzQa+AQIh8EYXivZ9h
# Fmeitd0+/lJzka/FeC6NwzGdnDjiQUeTwW2ncSfIxgmJ2I7wZR9Ewg7F570kijwY
# YNTwsThOEjLCe7pJozV3XzLdWTOycTGWAHVDdwykp0561v2kt2ebCjhQnYNkraEd
# pXH4rqK5sHE09GHQ+5WldyUpswJoTbZUKLGb1Ie/3NjZ4HtUDVEwl9Cl5Mzyztrp
# BSZwr3UsKiJeAXb5HlUjxyoYs6c2Jho+I1CqX6CupRkPT/vcb1qNua3UepG98HNU
# Txh2D4ctpM5iS3zrjoB0rKYXoYIEBDCCBAAGCSqGSIb3DQEJBjGCA/EwggPtAgEB
...
# BcXTMD8GCSqGSIb3DQEJBDEyBDBvRd/yDV57gCIZ21l7QdKyMtcOUPOk/Nw3lW90
# O9h4nzaxsAHbFKO+Rr2+68OwsT4wgaAGCyqGSIb3DQEJEAIMMYGQMIGNMIGKMIGH
...
# DQEBAQUABIICALVkZecJBVPpmmtU9aT4+oZDEjtLT6I2YQWb0HmbEJUqsF5OVbSO
# hHzkNzwi9cWzhsrb4jKeyh8mEF4bgy1b4zourEitModrK1MploQXJwPz+WE15mtl
# 1zP8239W4mr1VK40dZzzXswlT2I3XzXfl+AKcuf1dlXvn5LuPDBaTOcR+h+Ju9SN
# E+DvvUBDRXxKz//L37U+iYTbaxozBVWDkHKRy6aDfFbuLrXie83w24PrOdY/i57Q
# a/7U+kRip4ZYNAqctizH9YzbX/V4XefAO2Emk0Y/FPa4nVlSbXVdGj0UNUj55eze
# HLd6K4x9LdIbRDdQ3Q80lGugnTt/QQL6mosVSI3P7a2w5os0BlbsT73d7qAjsMtY
# iqXwmPYlHJE9lEpilUwiGNJR1wkRUWRXhCZTkpXHE88q73ychLJUhMe0Q70LmeHd
# FzIOJCjVNNQJnkMAZd9E+CZiIfrUHQyxqvWQUmna0692sM9AxY3AMSBy2GVrm4mV
# rsmODg2X+mKYhM9AIPqtYMfbS/X6mFA9DuGM8tYUudCKTPCE3nFjKKXIR8t4ACiC
# w26s9bBFp9WUxELIRnlaWgyJ31Vm4m5NAaM79yRjqo+l2tgwIS0i+ES/ibR/tpdw
# OYO2hZwywz8C7qkmIz5kFFB1MZX9ENcPWUsoeIWzNKouHVQESeTJm6LI

Function Set-DEDevice
{
	<#
	.SYNOPSIS
		Set Defender Devices.
	...
	.PARAMETER MachineTags
		Set tags.

	.EXAMPLE
		Set-DEDevice -Token $AccessToken -DeviceValue Normal
	...
	.LINK
		https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/update-machine-method?view=o365-worldwide
	#>
	...
	Process
	{
		...
		{
			$BaseUri = "https://api.securitycenter.microsoft.com/api/machines/$MachineId/setDeviceValue"
			$Uri = $BaseUri
			...
			if($MachineTags) { $Body['machineTags'] = @($MachineTags) }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCpICcvg8fZHA4N
# A7zh9F75mL6dql3bWvbwoQzGvKJo16CCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAkmLVWSKbkqmK7GwFRIP9K
# wwpck9qDvhWior6INRiLeTANBgkqhkiG9w0BAQEFAASCAgBrxj2JNvJcnswyDqsw
# gm2xAqrpXTc5Y35uJdJgHQsty7hlcouIK6NBK9t8DfRH/i/XfslX1ErMjZ/jVbof
# uGZ+Eg4mVqTh51QOj2RaT5NbH6h11zvuKmGclIj2giK26Y9vODOaEhjYw9xO0lkl
# YY3N/Q5UAq2l8TIUBGizRQ9B76aZ1GajyIBC3l4ZckUG1jjZqP1Kjcvavg/OndB9
# EDKwMdb6oF2UPnX4lgvPk4K+c2gsm3vz8keYA+I1Xtc/wpdCRdWycy0e4XVXW3Ag
# iJoVpj7TwZatkOU14KR51vIHPil1kpzwi6W8vrDC2JqD4oCP9AqHuLSeMFfaI4fd
# fqYMtNHkuCxDE7pR3uqy4oYMk1+mXx8+hIhCcJGbJo4wTuGyfX8cuF0LlsRxOFay
# sOUW1gK13o+zNZT/Z3Jckqwqmo81FY6UZEe6kTRmMNCEVD1LTGDLfr+Y46+MhShp
# /+L92EHB3flNBSpPCljDvAw2Y+JoFDJbR7+ZvJGD2xB3AiMsS5TTpRqDieBXpcSP
# CCzdzfdY++6u6jsh7b1UJ9AQNI08Up175EPNcDd54ANUwtM4ZzMipsXzlSijGKcB
# EVVrisk6nBqaxKv9vxkLS0ODpNqNJ14jAiiox50fhCMZaA+Dxs1ljqrDg42livzu
# P70kuW00kMX6aSVlUOjF+TSpBqGCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# CyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yMjExMTgxNjE4NDVaMDcGCyqG
# SIb3DQEJEAIvMSgwJjAkMCIEIAO5mmRJdJhKlbbMXYDTRNB0+972yiQEhCvmzw5E
# IgeKMD8GCSqGSIb3DQEJBDEyBDBNQk71ByRCKYxIgFk0RncKVVyQRrtUCNt0iziE
# fYhCxKqTAtVsj7KvJx+yons8xdYwgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIANADXHzBNrrnKVXqvWB/QLD2ZNPlTAOhesfd7UBYjXBHAR2YG4qGD
# mqa3DIaO8kI3ENQIKTYVuoVQncRo9fELoQwQJq13osDKQhIusDpISdK0NEHfs0hT
# +YX+E+6Krbin3oH2+LnwQdL3aaizkkvsyWTj/pzL/FkQT4eWTz9z4jhZPjigRw84
# lalK6MGTF//4zSBRBzkvWd7BLaedTZHL7Jsnw/FmaEOpzkd7I9DwdHOu90cbokle
# Twg8s39rqqU7DhtQwCydwRssN7SPrA4NoY/ubNieuq7oqlFeVxd/irW4r+PMk9VR
# CzfE+XhMTpzS7nzBny9sOs5l2aSRqyqYu/5XGmWm4ddUs5q8Yn7s57+YWfKNf2wu
# RF2qze2+9xQDStZGPHgt3WzJJ45txkl/1F76KNxszDY/rFbDuoeMXqTC5CdsAJeI
# DCUVXKKf6ktiL4nG8PITwoHHEe5wBzb5rTRLOoOdtgnttEWzvzsqINZtBFvu0MEu
# Qby8ZJpDTU+cL3W516LVbyxiTbMh4wgKHgHkxGxhxUUWcsCGuCg5beVI34WbTj5V
# YUX/FHxq1XRRaerBl1gpLiSZGWRRTXa/4BthaX5GEKIGWdsBDbSOrnIgUw+q26cS
# 7crRznwjGqdREK2Tn1BTFg9DZQMEBEkH083o8WfWegdA2YWXzzGnrYg=

Function Get-DEDeviceSoftware
{
	...
	.EXAMPLE
		$DeviceSoftware = Get-DEDeviceSoftware -Token $AccessToken -MachineId d32f67039373c5d916868cf4756ac450c2688431
	...
	Process
	{
		$BaseUri = "https://api.securitycenter.microsoft.com/api/machines/$MachineId/software"
		$Uri = $BaseUri
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCIZCnKijWyfcWm
# FDHJX0WIgg0AlYTPHrPwjKghzTe9lqCCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCu+sJi/KZqxVvqR0i4bURM
# 80LaLtCgQCzci1CMgvNxqzANBgkqhkiG9w0BAQEFAASCAgBbc10haTlVaro6hb4L
# 2soIoZ8gByyVY4Jjn3edimiiSgktUyIofZT09xOoW1pmN6Yu9y7NTpDi7JNTCHV5
# 0veWpEedLf82TCFZN3sqoVW74rzb/p1zI0iZHblZ5uh7hm31tIfVKE6CT+ieRVQw
# 13HOdY7yRObdgrE8LS3m5DGVM8ISllKCtTUZI91hr7O3aIDJiiApOyACRRvXw1Nd
# KkwdSTAH8mi+FVHA2uqW6xO1cqOPnZOPzENsCha+9e/c6bkipBdoO6m/WACkWc5j
# PnPSnHpCPtrHGz3O53oxKO3Ou4GQK+dbI2gl1+HK4Q1HlQdtomr4QAELw66AAqBV
# yxYok9OVwRkCcpmVCFFJOuCVhUTaq7WAfqQayRbbBxocMDvtnpJbTUVzpQIyqXUy
# OuL/S1TVLs3fOGl2KdJvBnvK/UDiCabQ/VdyFbL7oM8kO1dIWX9Cw6CkKZbUobVU
# Pk/oZrI3Nn4mC5IE90i+FnveOZBVgEmk7EqEeeoJ94FHF3IjEpdcNaR2kvz3Meij
# Y50WgcOeunNQs9qnpFMtmzGTuHZL0s4Pt4/8ZbFePecYajfdZF+AbQPKcMzSjEiL
# 8TS3K1DZ72o9uytg9imPLQJc6dWzhhKECwphTKxG9gj16KSBhoVb+DtSPilQza/M
# q/Ft+4Ck0XHa34h+TmzR7PuXnKGCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# CyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yMjExMTgxNjE4NDJaMDcGCyqG
# SIb3DQEJEAIvMSgwJjAkMCIEIAO5mmRJdJhKlbbMXYDTRNB0+972yiQEhCvmzw5E
# IgeKMD8GCSqGSIb3DQEJBDEyBDB7qxorskzIaexICRYF3C9W6/FsrZLb09aJR1kZ
# pqwj4AsAzDODiEDO9lL+3WcFM+owgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIAuUxbiJ/xV476sMAW6rqESSmAG3z9RxX+P4gDXjLW6QITBjyyLoPA
# NGV+3Yhwp2IyJjKJ+cVirlnsokKVP5OXakJQSsV2UoVI/jZXME5ZTzMwZEflPWb/
# oufOXMe/uR0N8mx0pHI47UNqk5VieOcg0dkLT8g4vW6MbDUFiQsDV4xNBeBHeHn7
# W6cdBTZ6i77/riZnPynPzdi74XNVU78281shuyH9J8ZXP0etkwfC2YrmiDlq0VwW
# U9e9iP6LVlSr+IvtcSc5ICVtV7iI3nNOeUxmoYJA8xXq2SZo+mY4R7OEb77i0T9U
# C1MJIPe0YgRMAFY1q+WWbvSFOHGDPrIx5u2ats6sWstRjnriqdMSO2ss3frSzdd+
# 9jS/Z+KYJd5JnRlrGhiTSQ+BwqCON3InZswkr0a98RjnjqHzCilkbD0hjhHFYjGa
# qUqLQNu7Ck9VVtlAS8ocln8bQQD0+xT3O+CjdCz/Sbmerc4CH7Td7YlwXhiXXD6F
# 1Tt1VB03G6rvgfnznYLt+RJ5WoDkpeAUjQjBGpdXnYyOzFqVg790X+db7VLseOoq
# Sz//zsqw9OP1zCcGDiv0fqecHJQGCggQi3Be6afRCn6NUkmRi9K8ANIbqAH7dnjC
# LlEd8uVHTA+/tse1I81RGNcMEQPDPm95OgRN3nePSxYdwSpezEQSh00=

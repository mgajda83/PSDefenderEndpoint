Function Get-DEDeviceRecommendation
{
	<#
	.SYNOPSIS
	...
	.EXAMPLE
		$DeviceRecommendations = Get-DEDeviceRecommendation -Token $AccessToken -MachineId d32f67039373c5d916868cf4756ac450c2688431

	.NOTES
		Author: Michal Gajda

	.LINK
		https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/get-security-recommendations?view=o365-worldwide
	#>
	[CmdletBinding()]
	Param
	(
	...
	Process
	{
		$BaseUri = "https://api.securitycenter.microsoft.com/api/machines/$MachineId/recommendations"
		$Uri = $BaseUri
		...
		while($null -ne $Uri)
		{
			...
			$Results += $Response.value | Select-Object *, @{l="MachineId";e={$MachineId}}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDtbYr2Nr4s9ELr
# pT5uG359xzvlXuhDIqXsOgzPdYM/yqCCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDtn17LnC2FRKZ402r0TCGh
# WrBVt1DYL+Mk+N0IUqDLMjANBgkqhkiG9w0BAQEFAASCAgBI7au9Nc3VZnoAHcVY
# XNzHz9W1r3eGNJY6BGWJUTUTmtR3ncP/QotLLYcPpH/V/bfT6mv6PTYPJr/ns0/A
# UpikrZO4YzM/3WzMHAK7TZ5wMQRgj2Md2SizLe4zbksk93x+XeZ8MxQm2F3CWgvB
# 6HojXeE2B02zYuVX8MJZbnynA6z4yYytjV/LzMxagvp+JyOP865qx6SIo4lKrKOy
# qSImBzrPNMUe7ZE4o2vIfsQFAhuR3Fy77XJFOFtw59zQytEbyQnKa9UBLEGlktwz
# ULf4aO1TP+q2z34jUcyDI6XPldaVVctizM96rYDR79NHsvwuNTH2QBY+jD9j5zPR
# 58sZkJFrj0kjPjqLKDUMEzq3SOX6UdXp5D60iBDLmGc0TYF5WoKlLuqEfDd7MP4e
# DGG5t/gI81Wavl7NgG4cDEzwJuVGDTtqd8Zo5MMI73sIWwnr+5sRR3c5CSA4qDiL
# PaUWFR+veym/fMyAUZa02C2XRIl0hTJClFwsDVRze16CmKXOPnYixYD2uX46pS7r
# CJeWH1S/ooK+Rya+rSPPNjR6HM2vWrurfqKLq+QF5bYvQ0M0G60DBmuAlqOJnoMJ
# YB7vtpgfUPOjdHFSclyQ5JOU5tAVFZtkZGyy0KZfmEgIcrXJNLK96DvWCtat81RC
# mLDaZOnGXed1E9RJKZhWBswkVqGCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# IgeKMD8GCSqGSIb3DQEJBDEyBDAaXxPlJCVSNUaVb9pFPW0t5zfKurVtG8Nerrae
# VGJrbaVVjH+Vop3hAqVJzY6fJGswgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIAX58vh7hRmZgYKFYKUHBFpdWR8AjQbAIDtBGAWGWktaCsaxMdq22c
# rEwCT/tvep5XzlUPjhY5i0+UHDWQdFujU7gGVMkehl2R4FuOxms/zfrMjTJnO1jD
# /cXm21TpJb2hasKft1IaoHonw+TSLQgrPuO/5ET9alFWRq5oE7dyf45qykfsqzHy
# PO91AmcvYerxQsEbjj9bXjw7wsGqSZjadIdUiZQn0a37g2FzgPUlovbRH05MIj7w
# TnWzKHYjrKdUEiR8ey/Ode6metW59MeHawjaLq5P63GQ/LVWfd24SvY7CrPBZNC+
# Va82tTDcHH6Ou3dzaRxFdysgRuzAmnBI0zakpGdeeDzir7crd3REjW5eUBjX8a+a
# 0WbK9YcS6ngzBJ/tWYecLFGCFoekRMbmju9Kulm2eouYF28Ju/8eEp7EWaxoV91m
# p2FQ9wZkhGiNtVk9gq7+zI56Dl/w3WiInAtLiLZR/FLfH14AjImblJYQDctK59Gn
# pTqM7Vnwhn2UaxPPlHJUWVIB+ZHxFJBO78M+EFpXewZzzW4ezlZ3s5+8z3bljrSB
# OLTNX4ts2r+3EuP/vL6e0FUnirs7YHb7qumAIsMYMn9CKOYxOZxkQIQgcNN/PNhj
# cbAbMXf/0oXglFKLrp4b7KAGSwATGvhn+ruRDdp56VvelPC+5AxCtGs=

Function Remove-DEIndicator
{
	<#
	.SYNOPSIS
		Remove Defender Indicator.
	...
	.EXAMPLE
		Remove-DEIndicator -Token $Token -Id 5
	...
	Process
	{
		...
		$Uri = "https://api.securitycenter.windows.com/api/indicators/$IndicatorId"
		...
		Write-Verbose $Uri
		$Request = Invoke-RestMethod @Request
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCazVkHvCblbkkY
# c+ly6rAPrZtSaG0hBQ1I2B/uJ4hdP6CCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDK5nIuStaRZdmActYYEeSa
# eNd+CYMBXmX4+e503XrvFjANBgkqhkiG9w0BAQEFAASCAgA5CtpjDkBQ1qvGDPlY
# ZX9WLGr2JCS8SxSSXynhf6gJQjAhuoZOv9HFBTf/YR3uUmg25Cr4Mm9k7H2nJ9uP
# 2wXbzPiWQaqBtkUC7TBLBYddRR3XNPg13zwksMzEEJFL6fMsJ10p7TJBtwBVCKEf
# dgJzxi+KT/mBwqOvZ2odTM6MG0h6vjKqEg/u4QDtIc2TSjuWVgHUEWZvKF6wMTjo
# rVObnafAeT4vezX3P3I4VVADIKVurWFEafLD0gHXht2k8rbtEuVpR8kTmb4qqOTV
# 5KOpWOQ647oLBHdL4y1XA5eb+xd87cFMWaGOBYmZ9mA64RzT203KwyvCZlArIoIO
# whMSfEPCjgv0OG6Z7ylilJB5qZGCgXZODJk+AtGwSRJEQ4Y9wSQDI4zmOL3dedyO
# IC/pxTgJtTj3vkWTIfzyF4tebQKom4oHE3q8bkDv/c0zcOpsDjephGxy7G1bm1Wh
# /XBZ0iv6+bWx1VM9mujnNz4RvA/tL/Z546BumPCizGnUuyGXD/AsQFwSJBDojwrY
# r7QGpCddTMMx0Vh9inLtbX6oxTI/cHDg9ED9g3ZzZ9zQDnpEh3dLFj7k7qOgzsqe
# L3qmf8n21MyvcSnIPSUQqXJtJsX80Pm4T+deGnIWOyjZ84o2gHkChcLaFibn3aP2
# YHQX3qMGTzXCrxoD1+zE5P0kaqGCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# IgeKMD8GCSqGSIb3DQEJBDEyBDBT4dJrkbmu7Ojjai6PriVCEyoSY6dMWmV54OyC
# igot+ORdChzutiv7Jwwp/TOeT5gwgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIAsxuxYGPX3VT7V2toTr/dfg9toHF5y6DtgU8sFInvRMImx6ELB6lW
# I9C9z4ccw6/WAsQU0VuphZTLDVUacugjlyR1vd8WzHVLxTDykZHJiOhOn6e8cWu9
# O90lcjEYuBIamlTv8yddki3TD8TKls8wxRJNYa5wjGE87xUzFCUsMi8HqyxK6X8g
# lYF7oZ/3xRBGAoiGwhJ9g+oa8V+fwk+aVhGsVlj3/2SbBzdmRPK9FYGivX6cerbx
# 1iF4/y+cI7TsO9Q/9GkVoy4A0vElH10ViaiD9BAMBbsQLZqnl8SvHyY96Mz/2R3M
# CG6IuwQ7qpWMB3mgK/DHOQzLzvmvISCF//2Cp3TCafreb0bqABGPKwU9g/RYvvqw
# vKYXN3j5zAoqL25xBdfHaS5eAit/07XcrD1ArgSVFHt6kEhqizI87BhgSwOZARGQ
# BOKvbIbAVSlJ1vCTTvLmKbnqO8IkdQQ6wqKhds06G+YcFaEzj40Kh+YZdXHqKBcE
# 6Gt6svXER4QZOkZhRBfix4QUFbLQh/qNS9Rxg3GkIjOiY/vdv50kmdkuP+iTnn8c
# GsBF/YoVqxFacdVEukz/npfVMzLv7C3/sGpmoSBUIdYs7Ua+XsA4UWgtSakD8laf
# SKBa7fdVPtDHjf1DKkzfTBuYtCH7OVXkbh9mrYxGFXPzQ65DrqTcxjk=

Function Get-DEIPStat
{
	...
	.EXAMPLE
		$IPStat = Get-DEIPStat -Token $Token -IPAddress 1.1.1.1
	...
	Process
	{
		$BaseUri = "https://api.securitycenter.microsoft.com/api/ips/$IPAddress/stats"
		$Uri = $BaseUri
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCARBxAAELeK3RVk
# +dY4Neqtc6FB07dM8LMZpQYYR1AU/aCCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAkV4fL1LGzCa8wU0o9rW9L
# 1nmOWwfHin2qzC5XREwxgzANBgkqhkiG9w0BAQEFAASCAgAp3ijnj+bae76aCKNd
# g/Fs2EQQeenEB9FLwMTtL9hhHnqhb6q2Ut6bUAb6t8QqaEvUrFkK3eTvfp60cULt
# SsHFVvCXcQLDWOqt0NM7uajaCuzie3xycQBSmr6bN2UNLcV32iVvlt0V2FSMQMWe
# Iik2mRgKk7B8g+lwfD9Mo2S/Qy1zJkA6I972azKwwhbIzw+uQy7AJ6D+LGCXD6Dg
# xBwWnzg52x042GrvMkMX82XWFfKBfmFeESPGdV79gg8KVASjH7VrsBAA8sJm34JK
# IfFcPXw0lr1DQP0j/WVOE0Sy6kWfXHiJ3SqOEg5i0rz4fGhF+9XsEuVYMA5GGSUl
# Dews6u6u2ZWQzU3cTZUpgQmd05cQVCp0hD7dPCQnlTSseUQGmVPibk3cW+K6JvsZ
# BVnCYRqrxQje6IEAUgI6oPBigDj8HDhvCyqfjvIBcolAKsubgmO3dEC4nKs2ZDt/
# pWlpQXaisfOwy3xjpU002xhxOiRfcfMfZ2NgYmfOHyQmbr59dVxjdZtVFATvyrhL
# nhRDwk5WEBgcpoRhF4AB2CDtcvy3cRxDoPX8d6SokAOyVJn6mY3WegSXcoXqjdbI
# ipIcTXzLFUTOkfgMsH4bdmJQV1YLprZE6U11/Eqayr5uFx/xRlqWHGWe6c3dTDG/
# xu9N8GRc4OexUhXOOAMgt3Bu0aGCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# IgeKMD8GCSqGSIb3DQEJBDEyBDAHeJHLlwmXwVQwxkDzRRglQzGLHlz3Nk3H8li2
# OdpLgawvFakhPx3etx5JStlPl94wgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIAfXeM2MY6q2jxoGuDxW0TKLaWWlQbdFTJz7eL+5EK6MWNVC2PNf5W
# hF1Jc5KMQbw/8rLpjrw5B6ancc72Z5mOYQFuaIcJcYpbJJo4F92aJioYCioFsw1E
# qvfxUbfUwV/Xnna9x94JOFIAF4TteA7kObLcLnKJlirawXmQYt6883Ttj3i1jvc2
# K+bdpxDsuSCYeMmRiv5pNILctUQkFz1aIbv/rMlce38sbUAZpspn95UgrkxHj9zv
# J2ODRNpqAHNJAPtf+iVmqpM8zZ4PAPMDTW59PO+TTABu7X/jkNxjmiRUunvOaHxK
# B09vNwMQ7UTJ8AGeOZ24Q1CLBPlOZn/bkGfhjv/Zvi6gaE0PuhwTArnp6t2hIH6t
# tijn9ztbsiP/Dfs/3gsyxbeWjGm1MAdFiYEsJe5qIHvfCGSsYACChzoPqDJaqKN1
# DpVSHViSEhkbPRPEE5AZIAmnKVAKEEZX4d6/ojnXi7DGOyD0ELVaa1Ff2gVMvN2Q
# 6qDpGKCBeULpt3EfBqjtQIt96TJGXaxN/ndN9Di+9SiFkJfSJ9q+sBJ5xW128H3y
# kvkTGYSTywcrBJaX9jWkP6oPe9seS+/erkNgPxJJTjERtAOmts74ODZZDx6VShNV
# BYJOPHAhaktDWreRtZNh0Owg5CsRC4f0Zg/WH+G1rJDUKkVFj8IEjQw=

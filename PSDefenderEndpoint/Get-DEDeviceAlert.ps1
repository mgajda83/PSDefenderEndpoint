Function Get-DEDeviceAlert
{
	<#
	.SYNOPSIS
		Get Defender for Endpoint device alerts.

	.PARAMETER Token
		Authorization token.

	.PARAMETER MachineId
		Machine ID for Defender for Endpoint.

	.EXAMPLE
		$DeviceAlerts = Get-DEDeviceAlert -Token $AccessToken -MachineId d32f67039373c5d916868cf4756ac450c2688431

	.NOTES
		Author: Michal Gajda

	.LINK
		https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/get-machine-related-alerts?view=o365-worldwide
	#>
	[CmdletBinding()]
	Param
	(
		...
		$MachineId,
		[Parameter()]
		[ValidateSet("Unknown","New","InProgress","Resolved")]
		$Status
	)
	...
	Process
	{
		$BaseUri = "https://api.securitycenter.microsoft.com/api/machines/$MachineId/alerts"
		$Uri = $BaseUri
		...
		while($null -ne $Uri)
		{
			...
			if($null -ne $Status)
			{
				$Results += $Response.value | Where-Object status -eq $Status
			} else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC6vz1pKSLKzWka
# o6GyRKVmXLFLsDRWTAr9IyzsVXRC9qCCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCX4pvWMWjEeIvQZynGOJqU
# utl4RVKi1wx4fzFC5+Cs7TANBgkqhkiG9w0BAQEFAASCAgAnULMPMzDTX/78RbGo
# d7Id+JNc3ctvzYEV8CP58Hi4qrrikmbJUac942BiGo+mE/J+M2gN0aAAv4odolQv
# rkM63EdMfnkfJkFvYtp3XA7sb2oq8fK6jiRvpU1i5jOQuO7teY0i75Z2EShf7ELR
# 93FLmC5On5FeAN4izL+V5jacnKc6ZBtB0gu2rUoaI0m7eB22t8l9Y5hpWZy6WXtr
# CikW+FyWXlEeiS6bNMiYh+CkalN6c+pt3/wikOz/7IGV5IRVUzU2ZBFCBhu4O6ad
# Z5LPjrtfdLfRanpugbvUaH5lseRa754aAszNYMBlZNAfTeCAZaKitgMFnVRnuJ60
# 6vNt8XU8S1oRa7+zR6oX4XJfnC0FpznJiLc4flPICafIhirgDy3tq5GaLU+3IhGQ
# Iu6pJB0gVmN8pN4fzbtaeIsqgUzbKq/AEsnyhx66D9E57aDqDNedX8QtdeMrp5e5
# BIzPIUrl1pZhj6vtnt8+rR8LgAr9eRl7Os02IcK/R9L0pk/ifK5Xzm5BnlBPzi5L
# HfxSO7lZeTDhaPQ5L3DmqplaBbsisWF6ZavJbCm1KFQmvPEP5f1gqk7EJ9s8w6li
# m1okjZiI4uiXPEbIct7l07hENZ5bKI9H9l7fDP/10bbUXGSzXkHDKRCetCnTHad4
# g+gulb9tnyIXKgj2pAx0W2bpzKGCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# CyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yMjExMTgxNjE4NDFaMDcGCyqG
# SIb3DQEJEAIvMSgwJjAkMCIEIAO5mmRJdJhKlbbMXYDTRNB0+972yiQEhCvmzw5E
# IgeKMD8GCSqGSIb3DQEJBDEyBDCXCjM2/yhFqk6DBtVyAnzahicO5kahQkEklFwv
# 0xl6ZvPU/CT7F4Bo/zD2jL28rIcwgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIAjE9vCWAGgqcvCETbwCxOo2uoEQHTedROGSNrYVgVyqsOhZCpM692
# UtaR8Ej1c/8LxzGDoFg0bxogHEPsfNQAxC9LKapCnLZynd/mHg3kvmSScW3kZkEJ
# 8ye7zvHaQ5e1NwLtZBWW/QL0oEL8x1oOQx2vh6u1f6JUraustv6dvW7NCMZiOV6J
# 81kuh52HtfmSd79N8kgpq8EtMbbMrIrui73WS3ePWlh2GffEgCgwYkUIndZx468O
# tYd18UK5F9OLjUPNL7TelDt7Zjx/0PZ3tcg+lOmO/SOUAhoEJco2a5d2kk09YKBr
# MDQFfAi/cx3dcL8MCkdCBRrrbrgCZtJYO1kXVdQhZLJpelozpqgc5Z7eUnaSLRp1
# n7pqYeB4oeieNvCvvcNinO3ppGFmbC4FPN4KdPFAvv2IdoSxv0egDwkAo6U2SobQ
# X+CXArZ2QPaVQzXLLVRtgS6wSrmesRO9yisB+pn7zX5TMlJ1vXTVePvbY2qSW937
# /O/G4Fgpfb8URxR9X1jUm8xLLqEAxYhXWumu6Z7xoi1qf51vk1hYKlqe3DlS/ayN
# O2eSumoRr+VUeuoiitr1P6JFG/iQGpc52TQmqgEkv1/e78isWUMQer9+Bizb0mH0
# 8bLlMbFDEs/dRGbclRELEYkt4iStAYDaJwnZE6mCyNK09NPtVveLTB8=

Function Set-DEApiConnection
{
	...
	.EXAMPLE
		#Connect to Defender API
		Import-Module MSAL.PS
		$ClientCertificate = Get-ChildItem Cert:\CurrentUser\My\<Thumbprint>
		$ClientId = "<ClientID>"
		$TenantId = "<TenantId>"
		...
		Set-DEApiConnection -Token $Token.AccessToken
	...
	If ($PSCmdlet.ShouldProcess("Save connection data"))
	{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCU1apc+kcvaxId
# uVmOlQpZ4uS4bIiDXagI7lJu12KpgaCCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAQeJHhHeRwGBUW8Wc0uZTE
# Tk8of127EFdt0BDQ75c6tzANBgkqhkiG9w0BAQEFAASCAgCWRnZO7hNVSj9X8ETV
# RzT+quz6i0AcMl5MNqB3PWqhOdrTDjo0N40OH4FQFLUXbMD++nTnp2HrWbrDirMA
# zp2T73GyNW17JhYQA3h77mlJWo64WUEzX2JefZf+YudWX0mugWCLaWdeu0c58Is3
# LUPaxDvk5O/Fw9HULN8jdItu+uINguKWwkGW2OPvV/dWRIw/3256TwYgIlD6SrYc
# YSaAc6cUMvwbRlkdLhmV03mjhu8EF6TsplFw+ziXnYcbqxafmKztpRjgBZHIBf91
# ctisgWsZS4TtrESGcgVjhnst/X0KQdp7kXpwoinQpZX8Qk7LWGIEb6SN82OsiLKb
# nKHnN6cS+ssa5uLUOYZl1IwJfo24Y9W6CEEDRgF9zcHc173gAYG8qr6BnGnrMq7V
# f76Xf03sZPFqhId2kjhEGXQT40m1QNUuzO6ARqbeaScenfQCKJoftWjfWS7IwO+m
# LDnU4yEWvgsN2LDGBlbOsT/774vhKoQZncgKHjQFvtYB0tNqapWQaRlaghLx9nbC
# +gA5zlsXhNEHIdcaxlXoK/8A7ZyvP6wNTPXr171+hUhGi48wKcYOhW/3KsNveqmu
# e+E+T7htDFaAQYsMkMW5UdVp30t3qkp8LicifGe4SgSu4e4ejV2HZYFHNjzXLmwP
# 2CVeniu6eBgQClp0joXRh+IVT6GCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# IgeKMD8GCSqGSIb3DQEJBDEyBDAGGwiBocxvCiJtpqLfYpg7YVZDAEz/DmI45gFd
# h65kvwRkZdnY/drkczz2/Xfm0v0wgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIAlHSuAXV7a8LxscEVVqTWgzwOh4Hxlu0g5DIBS3rZXpJ7Xvf7O7Ke
# 1HoaQkjIm9Iornk494gwWkzV9btpkVrs40iIvTRtIwlJzbmp2fTzCWKKrZIlDHha
# UiPaZv5EXVV8SdUKlQW7Y884LsxilLT86IO4voXEw9Hoa6ZP7mhktPeYn8jZOEj8
# 5OAkVDK4zCYxH6/v7LUhG/QgRAothZbRDAV0HI7qTx4wNPu18oMvkBFIadO3e07h
# fXsO5z3nRs8q3bWzsxi4nqJ9QAGF/MrmIlpTBAwSnJJX6U/D1rCOXO6moOuCe1wd
# 6r/OxQaqDNETFisa6wQqimCZRrR6aHUNrmKaEAZex2CooJqeS00Xw7LF/1ve+4+I
# TtYlxIc/V0gAAGRt5sbSNDtqjBScMEpFSWfQlzi7k+9VPZ8Sf9g1ho63YziETbk9
# walvSd2S8iv0gs+PBQh70CKnrqjyD+6z7ykNTn6KvWs2MP49/VUYOc3D7yBegCXi
# RcI7WZjOmbN1mstAzPCYB0WW46mqHQ3Oz4OCnJLorzj1HAoYmWxXhAtiVmkaWke7
# KDn0vAV6FE5eewwTTu02HkZbAM7lIC9Yq2+3gabAezFbGCJ9sKJ/EWGg6EvQuRWh
# P+X6/RbfuUP8qJ6YnP1acLqdeVz6QdK1vasaJE1xD3dJs9d+L+3UM4E=

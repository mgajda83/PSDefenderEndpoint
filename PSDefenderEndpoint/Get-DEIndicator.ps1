Function Get-DEIndicator
{
	<#
	.SYNOPSIS
		Get Defender Indicator.

	.PARAMETER Token
		Authorization token.

	.EXAMPLE
		$Indicators = Get-DEIndicator -Token $Token
	...
	Process
	{
		$BaseUri = "https://api.securitycenter.microsoft.com/api/indicators"
		$Uri = $BaseUri
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBIYwxYGr65vZGD
# xO9NRXhj3FeSOexM9IkNf2JrJG/pQqCCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAR/B0+v/BYWgzDwHR+sVk9
# ym8kElIHwcv2ZB2fGj5l4TANBgkqhkiG9w0BAQEFAASCAgAsCYdPswp/nMqHrrjR
# YKl5CXKLwksmY+tGGcAelqUCFvoflbEd0+2eZjI5KMGahw/TDGxEmswgclYdtafs
# vhUbsSslsTS+psK86kHybmnCV4C52dqyHOLDzBgHGo7h380l7cYAUEn2YJOQQYM5
# roX9vDa/qytAV6VV2SUNMn4ZfrVqX6Nx/mgCuyDFZS2sE2PwFNDL414xS/Kd0SCI
# 5in+mA69Heu/EA4pMSjrzjAcxmgGuwNpfrOQVCUZlvEm+WhNoisHSifSFJ/UVuJI
# PG+pDHie6DjadjnmiYlP8RRYYBb0tQvcKsMwN4JQO8va65KsfX/Y9LslrV/Y3wh+
# sWMQ2lMg5+v/m51lZNuMv20R/y0nQN3K5oGYNHm3UPU1pqM2G/zAGEJjSRGP483o
# OKOvqPGuhuHL3d9dQpHveD6dDX8I+vje/gvyOenKquknnKDfa7kwit4l0Sg8AByP
# 3pRWuhd/E60JiJuJ0FsG/s39qJqIHpGfYEvhgiofS7sYxinZZwx8fagcdTXNSOX3
# 4kty9OvHnMvoBgNrLCm6uEWM1Zq2r7T/TtCuoKlJzyHvu/c2HMap4YMtNxHraptx
# S38WuKx8pGlfJfrORApD9j+FmxYzF2hA0X1fOOWMMiqZxTl6t2NQ/UChp/FeJkcQ
# nPofNAdLF3NB00oiV7JKSb5Ql6GCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# IgeKMD8GCSqGSIb3DQEJBDEyBDANulSHMYe3ayio8VE98GasDyojS7wz5G9QDYAd
# cFVDJSJjtfvVdAtqKAx6tCblENowgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIAvs7GUZ8g+ClPi3uherFVL6DdC8s0SIQ3ZP8g9z+1tkylQTYLVYdR
# z7XSKeKFOAEVpBifp/AvxL8Q80DurBpdQfGwt2+bBStPxA7GUG2P9oFrMJPHDbVk
# K10GkoSrJFfovfBBiW4FlVk6DdujQaFlZFs7grJ/eH2f3ukF4zAg0Aonj57wRGhw
# HdPBVcvl52WDGHGV+GCBhQe9auoDSjZuRCW4Yhrxm0Fpj2vmVw7rY2VcFcf+Yw30
# WlXIe4tOdIP3IFORfpz0tLqWQXRpoVg9Ha+HXD/lqCWCdV0h4xuWCYbAs1xipkDN
# PiTH7FGdcLqbUwDTS/xKDZj2BT94FPzfGHHHgip0KkjUTdvxZyC/bjlfTs1cUo87
# IhronOsfQ1iOg6bs5CEqH8peCeDUp08QT0mB9I3ApFP4E2bio9atkvEXdkPOTOcz
# yfk6O+qMKWCdb768TFqocP+yD26+Ajs1cYsg0GKXdPdyPPoh2NfX+syBY3EkmGwW
# 3zuSHAqIggXADs6SX5qoZDkCwhxzFCSLuVEFlt6NFxV2CQt39aVfC31ie4ZwRyF8
# 7pLJdkAuSNpuQZpC1nPMqt4wQhoTk3HRJLSB2Cj9Au9m2teG/DuTfKP9+BYu4teQ
# Tlh6byYpeTO1P2JCkdUZWj3nzSfVixVPjbHEuQsqmx9Xmmbwpp4HbxE=

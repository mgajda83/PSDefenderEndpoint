Function Get-DEDeviceLogonUser
{
	<#
	.SYNOPSIS
	...
	.EXAMPLE
		$DeviceLogonUsers = Get-DEDeviceLogonUser -Token $AccessToken -MachineId d32f67039373c5d916868cf4756ac450c2688431

	.NOTES
		Author: Michal Gajda

	.LINK
		https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/get-machine-log-on-users?view=o365-worldwide
	#>
	[CmdletBinding()]
	Param
	(
	...
	Process
	{
		$BaseUri = "https://api.securitycenter.microsoft.com/api/machines/$MachineId/logonusers"
		$Uri = $BaseUri
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCGLTljRA7mWYho
# mQALOUIxEONJl56Q5Inu4/ntf3rpjKCCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAI31J9esruusAyc5Xpn6wu
# HTRAqvs9gqdd3ytJsZISLTANBgkqhkiG9w0BAQEFAASCAgBaIqfMHzNtWYfESCT5
# UCJRFAZodUHj/Mr3gys3/j3C5+QUA558ozdYw+zG5ce6+HGyrbsTfd3JC88g3wBC
# QAO284sh3a0K2tE94JxVe4gClpFc9HR/rJvLuG2kQ4QKO90vH7l6LTRRpDQ3bmTE
# AgLdBFK/EnSTr1LIYg0ARllWg9PM/uHAnX628qaQeWiYa1RlgqsWyysKUDMt6fVM
# RVbh3LPUbvAcaRAeDNa3Q0KSdmmqUkK/vX2eidRJr3NfnyoPXFKFR4QAqfoQuvKk
# 6KHP+5eLVvvwkda2XjaRe3lAZ+vCBs4jNppiQq5NiT8vVeaU2gu1I694OgPt2VXd
# npn190DDx0/K5hoTn6XTORKraY3Mtk5izV7LFqwMIaH+inPCbaVfS+ExWJ+7jCA6
# HZPb7G+FngsPm9AJ7cB79ruikNDCXrrkn7MbGnGgL+k5DAC8xHGD9WyztOOTen6J
# lsdkDzWyuLjvKdFQdmGHhES6z1AjHhG/12yM8rIW8Ixc9m6qjzS+O7wnPJH6Mw4L
# DaJZokXJKd2h9kHoGQsXehC1Qp0FO960j77ktOE4t8p+aTTxC6CE7jAbAsNpQR6P
# xsI/CFgDmHArpURpYgSh3DGcKC9ZXEWY0rKRyd884KQRkoaG7w7onc3tPXYAOVZj
# bpnZPbCFcDVVdZJ0wdXTgNGcM6GCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# IgeKMD8GCSqGSIb3DQEJBDEyBDC0yvW/06odSC25j/+rl/ipgJh2TnmeOyTsZumL
# BCBg+mYe6gEvBJhRf6KqLJjBDxUwgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIAVeGbwPGx36Q21MpHojc0HvEtMI6sdPq+tjpYrcvzDV9L4ClanFbK
# 4m5a+E5C0jgo3QkA20RAPZh6cS+oOwCy2vVIBiaCeM1cT4+hpNx/T+QXyJms7y6S
# VfEB/YZP9pCZotYGogWQH2smX/7U/8omII6KPsbRATYtRzu4V5/eyTwyo7NFJvhj
# PbISM3n0/Qym6mgpXtcIwpraibRmsCkXBsp8uYjWPWFAfrhS/HHW++JEY4fb/1Ty
# yLF7y4h2+bVFisOaqFJi8htNs+BnhtjGoP2LIEAWEb7QuNuwp0sDBmEquH9wqn3p
# +RDLQo+cs8nJH+1mvZPKgJLyMKIETFKiPW6x+fW5BdESpHZTkeIx+cVMH8Lhlhsw
# KywnSOKcRiBmS6k4w2KkoCst1NqjfhqkI5i+bC+uq9dFxADhSnyZVZLnTCs2ibf2
# VP55kZLLWd2Q54zTqbSRh6uWzfSw8yuUdON8I71v1lkSkBB4jqg/JgftwOVIWg/0
# LdejALbZe0UOApOz0EkCDx1rVDltiQd7PZXG9/Pwq/rXpFXGknTr+RSj9qvHMwpN
# UfmF91favqixj2wUm5s7T5TQ+pDLiLl7fezC9xuIuRokLBkQwLb2k/vXY8luVYZa
# o6TI2ChstNkpxNIRgYmduGIcFPNpktM6T832WLNrxQagXX5zf2WpUXY=

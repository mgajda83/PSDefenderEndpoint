Function Import-DEIndicator
{
	<#
	.SYNOPSIS
		Import list of Defender indicators.
	...
	.EXAMPLE
		...
		Import-DEIndicator -Token $Token -Body $Indicator
	...
	Process
	{
		$BaseUri = "https://api.securitycenter.windows.com/api/indicators/import"
		$Uri = $BaseUri
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDe9/XsZkCC4oQP
# s3N7dW0rli9Tjszcg/xD6EWAHjngFqCCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDRew9h6HGID2mnW37PRAeR
# hPtUvHwHNI++wcY6MWqjtjANBgkqhkiG9w0BAQEFAASCAgAMcCM4wX2DSY3Ub/M8
# p7FM12O9fFMImIDyRIAOC7HqWn3nNYqcfFcODOqcfoVP3VtYEa4a284PmCPT+AvR
# JwFncmeNEfcYGnw3wUiTkvUSv8M+eCKUzJLRtivbx5JFrU3hY4CyifO3753i2umo
# vM7pL4dxPGu07vn9nKvQVSKDkYwPmpfx0Tr+8rQZZXB8vU2mn1cUnsYtQu/nYQDr
# VfPeBT32+tw+oeg6KB1mtEXWfEfYRSQatItbnd+pdnSr0+s8DQSfEGPcIezaiFRW
# Mb3ktuJD/LSBD32qzPQzcXNmnZCYLZ5RlcCm7yIWp83H6L/ag4JObkzRy0ro+pOH
# 806tpfwnFKVLPzA4IKKBAdeMAXPFBKbFQQ2on7pwJidWt4Qth4ZVHAoNeoG6QWz0
# kFF9sYedSN3Sng35XxgvnZK/RHAM3Cyvq2TKUOKW5A235fo8N3cg03P3v/nmDZFw
# 5ZL1KPwHI1uxpIEZB4syMvEjvdAfjRLYmOVmWDxTmJfxNSaUaWK22vbwtbC1+TcF
# /MPxntUP+aNduty42ESzaSvc7giMveGOqtoSNDYVeI0o4EAf0i44tYXHtjdUPyEu
# 0B/EkrlMObLQkBoDlHw0BYiZ4bxM5kTNaSfMT4IW5KjShOuRW4XOaQu0bntn9SaY
# FgGok8J8s5XXu4sCJGT+aVU8wqGCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# IgeKMD8GCSqGSIb3DQEJBDEyBDCYT/qEPMKapfXBj4xF6kBmvxAOAvsWxXRRkHG4
# EgzmghGpGgclTK4mYTTqG/S/kC0wgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIASQciCDSXkTRlBUJEgVHMvfTdlbbC6Mzwdwb9vManuRQp9UmeH3Yo
# 76meAk7eIjQTgzZ66pdbRGSzujSzLapLVXI62iaHGE4kY3c1sxRAgGSCbt9v+fTF
# L8o2evf0kN/6vOs/sDUieJjj6dqfQ8rE8tHoyMVgAcWJtm+8LPn9sM2REfkJVepn
# ocYSg8A3KWqLOeTbX+00qrgAxh8NfqDsA2Qbb7py5r1y3oUEaTQbZO3pG9YIoXE2
# wdKBEKaR7FfC308nruANBP6VUztTw/6ssIjHtiFi+y4fiyQitBi/2LNPIx0Ul1a8
# 0NLkASl4cAYIp3rzOHTygUXPSC1gBV+FHjJ8jbGKceiBIyJMB5Fgk4E19w0oKku4
# pfy0ZWB2iIlhKY01UCSe33WfrXdZMpbWwY/AnafY55TsrjdckKV3tQCQw5XGetyR
# 4AHP/s12tQtuzdRMLpueAsHpO65Zw4nRMV39FWAgRszefI4/3tVn/IsLj/DyaSs0
# 57hz4N4HXC1PPHrdeUXEzT0QblyULI8sP0qVEK4zjPUEgJPI0jeHvXKJmEFKjwkR
# KuAL+H5XtxBeceL0LFpVqS563YN8jHnGqhB+IoezhxmytFQAhbv6FxRjpOxmC2ei
# T3lgFFQX5WNQHdutHn2S5SLk1k2eoS4+0Dq9twnUcQUWu9wP54GatKI=

#
# Module manifest for module 'PSDefenderEndpoint'
#
...
@{
	...
	RootModule = 'PSDefenderEndpoint.psm1'

	# Version number of this module.
	ModuleVersion = '1.0.1.2'

	# ID used to uniquely identify this module
	GUID = '615284e2-0c53-483f-8ebc-cefa887129d6'
	...
	Description = 'Modul PowerShell do obslugi API Microsoft Defender for Endpoint.'
	...
	FunctionsToExport = @(
		...
		"Get-DEDevice",
		"Get-DEDeviceAlert",
		"Get-DEDeviceLogonUser",
		"Get-DEDeviceMissingKB",
		"Get-DEDeviceRecommendation",
		"Get-DEDeviceSoftware",
		"Get-DEDeviceVulnerability",
		"Get-DEIndicator",
		"Get-DEIPStat",
		"Invoke-DERequest"
		"Import-DEIndicator",
	...
	FileList = @(
		"Add-DEDeviceTag.ps1",
		"Get-DEDevice.ps1",
		"Get-DEDeviceAlert.ps1",
		"Get-DEDeviceLogonUser.ps1",
		"Get-DEDeviceMissingKB.ps1",
		"Get-DEDeviceRecommendation.ps1",
		"Get-DEDeviceSoftware.ps1",
		"Get-DEDeviceVulnerability.ps1",
		"Get-DEIndicator.ps1",
		"Get-DEIPStat.ps1",
		"Invoke-DERequest.ps1"
		"Import-DEIndicator.ps1",
		"PSDefenderEndpoint.psd1",
		"PSDefenderEndpoint.psm1",
		"Remove-DEDevice.ps1",
		"Remove-DEDeviceTag.ps1",
		"Remove-DEIndicator.ps1",
		"Set-DEApiConnection.ps1",
		"Set-DEDevice.ps1",
		"Submit-DEIndicator.ps1"
	)
...
PrivateData = @{
	...
	PSData = @{
		...
		LicenseUri = 'https://github.com/mgajda83/PSDefenderEndpoint/blob/main/LICENSE'

		# A URL to the main website for this project.
		ProjectUri = 'https://github.com/mgajda83/PSDefenderEndpoint'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBv3HMJj01uNCnZ
# dYUPEWdcQcNwEea4zErjBxZSNKkdRqCCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCC0c2y7XG0Si6DtaAazNHr5
# MpiGkWGD0XXwtwsmNvtHUDANBgkqhkiG9w0BAQEFAASCAgBArTnbXDbVMHhEtwOf
# qGE2XRl3bBavyYwkdbQtIjdS/oROqHk+nkKNggbixsa1cf884l6YBuqcpFxTpxkG
# EKrvhu11QyScOLOHM+Uj+UXpVCUjLDIKmY25TxZqXLIU5k7natlumPf+eJpiK1iR
# C0ZEUamqup//gsGU5RcVpA4qID9qF0p+LftcpNJsAMt3IMD2+UbN600pd9CyLGqU
# Yd8CWDQFEjRlum2nsRGYlGq/P/5M1iq5eg3onzQHdK+RiOkzM8G89p6yDGP6fsiw
# YepitOA5BK3SUiGrR8zWCESAVU6T2kXK4ptYWR8T/mSDm1kU09WSbL/QyM9zPgay
# zFl8aktwLWszgan/ZEUsRUpFw7TLs0vGxg368Ez2J9O+uuXnaSqt5T1Hda6tQUtj
# +oLy4xHTaq3k7u3r14foHUtS5CGmJgmXZrCjj0E5JWb3D6huJ1OuaJ7wxnhofrpn
# Cl6QP0oBRawt+VPSGf0zjwPP3cDGf409PfS6faMIM2AHj8EMJr3X0Ky0G1BvK/IP
# zZLz8lhvpneKGc4vslCcBFI/wBUt+aewmGyoyloHueYL0c70bSJeIEq0cKJfYAk5
# qSA+JdOvlBcAByb+4nD3BukD3JlpgymplqgQB+J/d9DkwElF/jcmUTUkyh/698lz
# 7BpJ4LDtlEqZ8Dyve/rEdSqul6GCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# IgeKMD8GCSqGSIb3DQEJBDEyBDAMKBaBwxDt13UYO5T5wq6jayNN0riTGfK97Wpm
# C1WFjpsYzX3cyz8t7OiC9Xow/WowgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIAHx2iFzWznLQBBCmHaPeY64g5evmMOlt4C03LRCDFWEZdRqnXBexa
# DTxfqWpUK919f+C+Uh/9RiCWnlRyBQ/l62EixCcj8z3jiteFrSgfQYHEkP79D/m0
# ku0qkD3E4Wa8fhihlCK/XdgOFoSClsO6MsbXWXxPMIiDUzLxi4lsE3QRXJZ8+WVf
# qYMKL7TtM+C+QApzLPHt4PjtG+s65nd8iOZZuqpfmyYBXZkR8zDZ9SCl3fYSgBya
# zw8geBqPtlU5ps4LLEar88VbqIHCRNzNFchBmS8Rhck/x0XZGBM1nQ5+8oMsjJKI
# AD8hHv2cVTI8utGyaxl4XBzaGCjWPgAMEaD+g2Hjkt85D+OIaVSwYhCCRhLY2kio
# 3YN7+IbkdwQEGGGFapVuSFoRuo8Db1BX/i2VBABTtKOGn/Dw37KPZRobaovWvmFJ
# qQn1lW7+19mOJiDIFNALz8ysIIsGp+sg04IOatxgrlmkkaBhnL1QoOhJufm/KAIS
# rr83CPCHOZBLY+DYnjaDLrbqVymMaq4OVDEp7XNhm6V3PBEfCU3gg481UXV0L47m
# TO5V8wWgCtWHGFKLdX+xO4Wazvz3/p7XSdn8pTF6TMLkUKGjkRebJqwFv/0Jw+KP
# cvNa+1LoIwEqWqrcNB8scumgOCJNu/CXCQjRYB4+V+JPRC8rcnu1utY=

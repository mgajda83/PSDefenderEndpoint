Function Get-DEDeviceMissingKB
{
	<#
	.SYNOPSIS
	...
	.EXAMPLE
		$DeviceMissingKBs = Get-DEDeviceMissingKB -Token $AccessToken -MachineId d32f67039373c5d916868cf4756ac450c2688431
	...
	Process
	{
		$BaseUri = "https://api.securitycenter.microsoft.com/api/machines/$MachineId/getmissingkbs"
		$Uri = $BaseUri
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDCJvjFcLG72v98
# QutQqU+kFl5jDnIbpbdNiR8wo5KMUaCCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBSia54PnnGVwrLW1G8zgqe
# TY70o/7FdihOMgdveggUvjANBgkqhkiG9w0BAQEFAASCAgBLZw2VkbDl95wi0X3q
# PYBxjRo9aSrdpUxHGCFT103W54/ZMyfT40b6oW9MFonWeRQOVco0tRmmz399qhC8
# uXdHlyzQk3aackYAfZUxCNAHqdi3MCY5fac9UtWf6CZeCVy3Gv0zxG6BgED63NMc
# oIOPwFcm951rIf+QNPj5GWZFb151TBBdi+KYCE5xSjF0cFqrjrJUDsR4sYhE5i+j
# ptmK2whD7ZslQImwaP+YqjNkYqFcVVcvdjokM9xF1gsew8GdfQEyEnbPy6+9yQU6
# ssOL8sRyYyyQzHKqIB5QsJert8nLeVHMknYEOQHictdqqfBZNjG3x16NvhqjPh8x
# ixuP9oPATwaDcZexlvSZw/fstllFSVTOCc0Ebmd3L/pK30IvdvOgpXJLgIpIAeuD
# 5mtVj4SLxzqzPKCd025jP4QkhHMGza7p5zGJcx+0JzHSNQr8MjX/p6RNMY/0zez7
# MhaVVUL4KejrQqniTGKkTHlLD/pnvPaotjH69TFOp75CvfZzCy/xzbOizfmGjgNd
# aEnX/sXVhn6CMHNHYcL8C5NHMM3KxwsHkkv4af0/KRL48bQIoNqiAhqB3tZ0+maF
# sQxHAyagYi5zaqEZ2kSKAEByHOQ9Vz71/mImdsCqqlom66F4MOzEZHGB7/cNF8Gw
# l9okMnt6oJ/vC9DbRIkIqAqIeaGCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# IgeKMD8GCSqGSIb3DQEJBDEyBDATVrEJwLQZ9fUc5M3llrhhTJ0r0UWEBGmGtg02
# ccSNpnZiABkVpWe+d/1IglES7XkwgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIAonU7ALGGB+kpqzq4nJKuCSDHHMYF0q2U3PBcCGUtkWIUSMwJKdd0
# qV+P5piajgv+o78ZQ+zxxDcKKDbs6ki1YfJc2HuY7SCcsw9yzvuFKNZuacnHwK7/
# EZ6VIsn9axfSGppgbqKTbPxDGPoHUM6CnvivXY9Z5Z5CXLIPLeCbGljercfk/M9e
# RA7luSkBvdhxOtazV3kRIcjJleLYKMNvsnT4VO8D6Ofnl++/Tx/3Rsfx9Ykn5+Tc
# LeiXb+B0K+Jtb9HnUaedbj4Ngtxop3hfDso5C6DcGty15vj/EIY+Jkwt3NqdO4pb
# bAPjc3qcunqEz8Tyb8MxqPW6arqWGtInMDLDAaNy8oH7M/Tp4DJU1FDIocqaRjAZ
# dWny1yg1SitAmsxc9uGfafdtdOob/W7JKQJzQftK+qY1q3Qaau96YYmbF4y/tqmD
# Y5IjkaRgGh3WYOvikTew48v84hG8cKWYjQwY1Ozb3XxZiIromw3SH6D1A0xZ5lPf
# GxzvQFiHo91hIn6PGGkaRU3vlyRao/LZdEfL4Sir2U+canWtiARE7+XFqKYLuXjj
# XZp1zKT7GNws6TEFlsTpbWXZUbrNk4cCBiNXt/tguJB5Pj2UL6ZwQ+JE1gLkIKe0
# tSZp/DhCFF5MFXeL8cPdkGJ7p1j+zVuqS6tRFqphze6EWOOM2vb5xIM=

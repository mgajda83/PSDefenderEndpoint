Function Remove-DEDevice
{
	<#
	.SYNOPSIS
		Offboard Defender Devices.
	...
	.EXAMPLE
		Remove-DEDevice-DEDevice -Token $AccessToken -Comment "Offboard machine from API"
	...
	Process
	{
		$BaseUri = "https://api.securitycenter.microsoft.com/api/machines/$MachineId/offboard"
		$Uri = $BaseUri
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBUMDPjofX2nJzB
# u0lwoKe2uc4g0hW+fFE2GN6Ivy8LC6CCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCyvYlYDRabigDiOifBCOPM
# d9qNb1Z2yJiwZUNz3cUuLTANBgkqhkiG9w0BAQEFAASCAgAD1e5ir9IZcSkhWeLL
# sfwbasI9mHR6l1WDqEsrN1jl+1UIRMBfXhbyYrs1Q+Jyc5j5WH35l70xhOEPodIO
# xsxyStxtmooMZZ2Gy3c5RBhTBaEzuVDLyvCVlm4iQTxmfOL5M25I4DH+eoAFmJGp
# Nk9Q+v5WDUFVbx+9wgo8dFf6QYOUU5RGqNnI/ousZtdChcTZSN97MTtTJc8f0BQ/
# L/4ZylADEJBKLzgmq7aCil3yGrmhgMbW6XasPUIxoOyfBh2HVcaqSlBWBVVsYwfb
# lE54Q0qTAxWR3ZJBuaUIpdZV9PLYgmI5DprfHQ8w3fK/9fVd+OH+uEhZlynBcmHc
# Z2WKQGD+UdvuqqyT2Co90XyAOgaOcWQnnr2qbg7ZVfWZb1cAolada9H5FIVnbBPU
# 2WyTKksyiEM7Ns1qes7y3JZYL5KRK43AzPhLvlCb8ixveIa3GhJ07eE+2Y0Zvb5N
# rzIfL5b7sxGPIrfCkJOcOMycVv+C+rXxpLKDk7mK8RVnx7PXxhhOc1qbaywaqGwj
# CvpByIfjDbLq4e+6su8DQLFwRYX4PuRp/Om4rt/KHIOd4CoPydoX8IkHyKVqAtmf
# OXySocmkfqzFN2EluedHjs6YvWxI54PgQHkscabbXzoVOaHIPXF2bTNVu5431GZu
# 91PDC3ZOwFukvldhADjCX88/FKGCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# IgeKMD8GCSqGSIb3DQEJBDEyBDCSJK/4b6z28baO8zVkuszyMnS4DfWwYbo5KVkk
# 6dxE6RuNSxgkLdgUsEtxpewZbzkwgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIAJ08g112B4OOOO6EERKENLTJ4AiGo5eOwnTYKizlq2cq04hRhE0a0
# hyxGAIg7BZ3jFcAX/H1bFLmFVWgGeVlTaaWxCTp4/cKdtZDaRaoZuadf3cvFAmgr
# b4+wUXz+UiQpaZF8KdChtvOrncK0CyP73Og4o0VsJ25W3YBCxkgunGR5OvtmS/ed
# rg46++Kfp7EhtJX7FDo46fHUBIORtfyw9G0cD+RyPtBeUz4PlQWSC8vMkl6BYnPw
# I0SoGh/SY/Me0qKUFMjunKyn2R+y07fujGIq30jgjU6Lga9Ld5sdHniEZBlmnjDS
# 9Enz/Z3Q9y2lVpRlGzDW15jqSAfuld326NeBOAxbgplQT0c0BSnDU45WcD1r2G8r
# 5sUICcRH4czie5QX9ZrpaOEpDMhiO/TExx2HphoUVP4ZZXdMCBZzpRwHKEAiFQa+
# clGlnOJvmp8JWlr8uU9jD9H42GC2UO0KijnWGeM/HjZ3SWHj2AnriM95Z8OnVgc4
# gjRSx6KUIWvtuOX5z1vGRUU2iNBBCJRmSpnzLqSQxm249NO4t4ADTGbeRyZFA8cC
# x86EZhhYxMX0h6Pezq47QiUudkEumC9EORA97kc4j9WzoCstHrxq28a2IeMsbRh/
# KzqMOaLTWldNCUmBJiYj1PLkPzo91jJo7WrKlaTeA+5Pp/U5PpHx0nk=

Function Add-DEDeviceTag
{
	<#
	.SYNOPSIS
		Add Defender for Endpoint device tag.
	...
	.EXAMPLE
		$Devices = Add-DEDeviceTag -Token $AccessToken -MachineId d32f67039373c5d916868cf4756ac450c2688431 -Tag TST

	.NOTES
		Author: Michal Gajda

	.LINK
		https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/add-or-remove-machine-tags?view=o365-worldwide
	#>
	[CmdletBinding()]
	Param
	(
	...
	Process
	{
		$BaseUri = "https://api.securitycenter.microsoft.com/api/machines/$MachineId/tags"
		$Uri = $BaseUri
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB4TnTOUJAkVFJU
# AI9zIvauxwOyy50KtA8rvf5N6x5aiqCCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCSFB4MCrkot3EIp1YdASXw
# 9Dpme1/rGzsnrW/LKVVM1DANBgkqhkiG9w0BAQEFAASCAgAubJJfQj6hCeYbLmod
# exvsO0M6kfS41iWuuopA+A7OR+l2j3dDE9ml1YthbugMK+aScW5483st7P7jkXaK
# jzd1SGobE/hg7tK619I6OA0oPV9/yJQwFS/kICUIHPwJxd303H048djk7i4+2GNT
# OyHAchldnHJL0fg0VrmIJiH1g7O08pKEwEyKpbxxPRQ8cARhNqYbhLguwM3Y/5Zf
# Q0ABfrx4BWVRxQKibDIdlqbruIcr3E7gLU3+59orW1aFYdCNEkaCiLq0sG3OByVy
# RXdMgljW5/kO2JPHjELeW7Tg/WTXxYZXf2Jgt2AjT16P1FAg9bGFLDfm+5nAw8xL
# lFUIPGN3vLnCECJ8DCJLrfnPC8HhfSET01uUBMOoir/uRVegXjsRwiy0oVVOktvO
# ZNzF7IXE3xtmV9W9d4Xr6MH6mf17MVCdTfZyt0TrsZpF361ELPbpx6m4lYBA0aUH
# TwZ8q7ZlKDby/cxrrRM7/DhVumYrWEtgB/qKwM5617X06F+UDFco17mRRYTfxLJz
# k87zlPEePa/Zs71py+/sR9ANnnhKTVzSX7SXqId1nFUiYmdyhUmBHl35xe87rOfo
# NtaD/u9nuhU1B9orzrVyZYpqLCUyop3iEaytJVDsPyDtmLkscQqiwTQXzZaY8HY5
# bMkrzmaGqZft2paUsbyDCLie1aGCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# IgeKMD8GCSqGSIb3DQEJBDEyBDDQrRGDB4wncjwWPk5dusn3e8ho2RUeb2BuG9a2
# zcf+GgIThqRNZE7r0DhmgpdlFJcwgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIAuWJlOR+uGshW3ego7zSQVO/2dCWvewP/2J53msR756pSfDsBuT6w
# UsxTycpAZvleR6BpyhAKXVZgz7+lTI1+qTGEYx8QM4COFBg8B1NWGRhMIINX4Pq9
# 2xyMCRGcDLhF6DTX5dDV4RGfhIQTuI1vs7DUkgP/OjzEKpU9+RKew7jbFhox52tn
# sD+bavuxv2jJRbuEJNQpUXOSHaAAxSF1uNnbhIIreo02kVwTTjBm5WhdguwmOs0x
# F+xVFX7TsoU5pQy7TPrktjRfU2GPklvjSz6ZM6E8lbKBto7NGkd7tUaPD1QGge5w
# QvvaR3I6rGzgMHOkCjGuxBVWCoe2fbS7cB6TL+3cuFdjICEk2Wf2agxikJH9QRUB
# Rem5iN0jEZTUXw+aVyu9FESlX90VmUZ6v9u880A0jpVIZ38VtqeLFeA6ar2H1Dm7
# Pps1dbCqhvRLe+T9oPKtNLwTvu1dntTurvVotzsf9EcLeBC1yXPFbr6KN7ubzoTj
# 74qG7dWxLWxttt967KZCf8+J+Ah22znzEP7b0VZRiPUHlR004IRHi13NxQqMwaQB
# LJM8T+aAyC35qTi3Qqe6tEGi0BAYbbUkOg7m5xdHhbkmV1xLUoJkA9OLiOrl7O5l
# VocUO6Ig8g5Q3jDcKsv5j7krldF6WQEGeXmvc7NIciy28RLl280ZIK0=

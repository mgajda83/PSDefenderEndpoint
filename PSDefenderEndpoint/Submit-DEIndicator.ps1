Function Submit-DEIndicator
{
	<#
	.SYNOPSIS
		Submit Defender Indicator.
	...
	.EXAMPLE
		...
		Submit-DEIndicator -Token $Token -Body $Indicator
	...
	Process
	{
		$BaseUri = "https://api.securitycenter.windows.com/api/indicators"
		$Uri = $BaseUri
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDVQXi18Jc1hRC9
# 1QALRPQcnx6nksWe92ut+0fQSsm5AqCCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCnpk/1+baAf/AXzPB9ZgLT
# F6b9q+6hcBktd2LlU5cb0jANBgkqhkiG9w0BAQEFAASCAgAheNzjOqFeUYXj7PoC
# zMQWwxB271p9TmysTummoGeHZKbOXNIPDvVUwdT/hdZ8VKO8+5xZ7zMN+JlpSo+o
# ggxuBmN3YCSlnyiKXTg1/r5tcGz3T1mL0aA9EXSPd7lmTeVwf7ABd5sODSHF0BVi
# /qy8OskLJ9fLT1uVsSinBlem4Ive7Aq/QiEeKz2av9E0Sct+R8fQft7n3tVDM8O+
# 4TbYgevDp3bvPUZusxDqVY39WP3t/zGkl9UMQIaHNy5ciCpf6tm/4NvARje0Dhii
# FqCECAx2nIBAPlqhKlYFi8ChS7YA+DYQVyPfSLlThMNNUEFDpV+5azRcr8WsPVfP
# E+TsCK1IB9y4aalwtUFNqKkzpN/tVk8McdsLPK6AMv6qcxQWg57l1E2CKlgLW1xu
# SCxpI6Gja5x0xqSl0qJpmCfki5Nla6WSINjcpDhCabAI0rFlZE5KBa/5V4SpwAv5
# g4dMDIXYRGujoacWFNVo80Yb01ZhhyQaND7BfZk8rKI44D+SEan2gzq6JnU10bxq
# JMT3cjmkiCeu8+Gji67e0IKWz6hnn+xDUK4sZw80ir609uC0xSRLZud217TiScLp
# w96B2GJ7n0JtZMLWGOGn9e0HTQQxTQ0pVo5GSSx9Wlxktloj6k8bovot0cVTuLD2
# oZQ0GdjPy3SY6tjwqVBDmCbqq6GCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# IgeKMD8GCSqGSIb3DQEJBDEyBDDqwkHOvWWFlWfukkJzRsZ2yn4MFMDH/WgrGLop
# /H+/6GaRVX+y5V+r823+ITppFfcwgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIAK0es6N4xaAYK+IlYQSyo9VCiL+J4/0gpm47x43tgxcKaLEkZ5xYi
# gpgDBeGpkBlnYPerEcSwBUJdRjisDbDZFV4DSppRVaxFluOdOS2HlZS7lrx+HbZB
# Ply3MPKzEUHbu/TbM0Ya/vA3nhKqcDRP171gJW0kAPBwrkXnomo9K2ET0MhYWtrT
# oeCc2V3MvVxLc/WGBX1aR0QWVwVadvbi0qfJG7IAjf4LtBpsSUYd6OQ9aR0flgu4
# JNXgFEyUpaPHbyQbE8+tXmKU1ojRQjL0mEdXkkxms0LYS+F43KgwENXYjW1fHTEY
# tVASFxAjrNAZyQ8FSGow8NIjbYAfc77CIOIRIjO6yTqOMI7wts4wFzx587UqLw5e
# G1WnBBwO0+FfT8hdL7GxaUmq8eRKSBdk30OhZEC1vhbFenFuF7WUKCAdabakGoH3
# 6pHFrrDK3HCJjGR0DaYiceue4zpxcEsnaYVb0X4CkvyeWeaUWg0HYWz/lgng2qAt
# OX+DaViLkHUImXJZIl8UAJ/3jUeMgGEZU3jFtaoqI9pR5vHoXeLJnZHLs74TZsb/
# uOVxVA50f7QneJ+YUDjsARZEZbiVskb8BrO/I6U1BJ6lDSGb/K9hL9m5l8Cxfqar
# nc+JLVT/LoFhkL8jQ09a82fr1bLGO3i6JuR6lOjULePvc1qphKeoUhc=

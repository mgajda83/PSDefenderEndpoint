Function Get-DEDevice
{
	...
	.PARAMETER MachineId
		Filter by machine ID for Defender for Endpoint.

	.PARAMETER IPAddress
		Filter by IPAddress in specific TimeStamp (15 minutes).
	...
	.EXAMPLE
		$Devices = Get-DEDevice -Token $AccessToken
	...
	Process
	{
		if($DeviceId)
		{
			$BaseUri = "https://api.securitycenter.microsoft.com/api/machines/$MachineId"
		} elseif($IPAddress) {
			$FilterTimeStamp = $TimeStamp.ToString("yyyy-MM-ddThh:mm:ssZ")
			$BaseUri = "https://api.securitycenter.microsoft.com/api/machines/findbyip(ip='$IPAddress',timestamp=$FilterTimeStamp)"
		}  elseif($Tag) {
			$BaseUri = "https://api.securitycenter.microsoft.com/api/machines/findbytag?tag=$Tag&useStartsWithFilter=true"
		} else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCADEMiH+BbNI9q7
# rFmxOKcavX+UqjttUi5GgbaQ6OupVKCCJnkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCDCCtrAiQw0iCYvpsXKiZi
# wdDNUscpVHiwZEbFtZj3TzANBgkqhkiG9w0BAQEFAASCAgAQmNpzjk1kK1pEsaAx
# vNPdU6mm/k7ls1I9Kat6o/VuTpk4II7HZ4wY8dq3AwOULa+9YbwlQZkg/tfBTReD
# gAVq5q8yss/hN+eF+tH0kP11JdBxWGotgtEVvFLI3PVAF+QR5U8mOsQYrHE9Upix
# hFo3y5hA0oSi+d1fYCjzJYNOeAa/6dVN067H9vExxpTFQpYLNq59Cb35ltxsfrnd
# DSv3WDOHHppsnNu1BLiPDBcr6/0tDXcwiZBM5yvUOgRWVD1kzkdBwjZTAQO083fR
# OrPioDLh/56BEX1tL2XB9AEePNw5w7Eah6xKoqG3i/FEy3yJyGjVuHFZDCTzv3qo
# 8NESzL4toySVzz8M/jfwUiMAMw6UN4xuUF7NSoqaS3a3HKgU5XGqZ3OoCUu9lSEd
# daYwTKBdOyRH30hPOaRep13582RXGKcqu3TIpON1uLFMXk6vBXopL+vMeuvZ0gSR
# g9hVcd1GwSyuIs3YzQ5A3sf3aCTcu7x8NS7GVvUq0zdW5LISGudcRbwNG4GWRm/W
# EjXFyv8qMnQG798uJr9ZN3zMu6jYmdbKvb+/E201XrmlJkYXuhup2uVqsaXdeQFR
# 0UWUK3R8GOWqRs0D85bAJKrCxozDzdmKJJeY1RGn9TQJYIo+xP8mWFpXHCCDclaP
# cb1SuU8ctUrHVQO+VXAVaVdBFaGCBAIwggP+BgkqhkiG9w0BCQYxggPvMIID6wIB
...
# CyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yMjExMTgxNjE4NDBaMDcGCyqG
# SIb3DQEJEAIvMSgwJjAkMCIEIAO5mmRJdJhKlbbMXYDTRNB0+972yiQEhCvmzw5E
# IgeKMD8GCSqGSIb3DQEJBDEyBDAw3POU9B5BaO1+VAsoZoEennXn/fEaMujS6bmy
# lnbfI924LzCLgfdOQpzSQKF8lewwgZ8GCyqGSIb3DQEJEAIMMYGPMIGMMIGJMIGG
...
# AQEBBQAEggIAYo2fuYkj1CUtqkJubTB945+c+3F0wZTq7OnHTzgfMsk5YUcQLv3E
# 0ddkuiJhv8qpJs8XnGTcDdU66NLEyF8QzytPyO/WDoS+T/bRYY+qM/k97M6rdQOu
# rVkSwI46w2LEdNk9FCUvSra3qqTFu26Z5F/d7k4Eu/WwAICXB6MG2M9h9DdUjyND
# /CXCCPy4ffjbThzYdqg/NQpkF+1fW0Y2od3wxHWfk3SxP1fwDXT9MQY8h4MwGNqB
# NZPe57UvlQMXD4kBd8HbZNU+nOxh0qoiZ9U4g4Jzgxrj34FZXl22Q9x0g0xkgtPh
# j0b9fcoQvbiAJM8Trgximk9MnXPQAxFZIJ+FCDVaKKRwDhbhloqyDJRQqkZGV/H2
# chagxLWkHjemUn+IHsmQdv7rFGf9yIfT63H3x36OXCdj8yrF6VJWkh+5gL/HNxwP
# SZuWImZX6Fb49TyqjrOEKIH69IB1ava/jy5/D3Iz1ggY85Lu7BMqrLIDsPPMKRYj
# myllNT3CIlSAnqCH6hfeRPKln5RHBUbCU2fhR8nSOscgETFh5xryKf0y1Yrx099A
# 9Z5BRvZ3Qg6o8SSH4GwKvd+ER2PXo1RmSkpW2gzri6AtAfDqNQpVjwB+eooCjXgk
# dFRx1MPpCoJv3P2lVblUbdsjWB6iNOeIGQhGfIt0yyh/Sh2RJDAFowU=
